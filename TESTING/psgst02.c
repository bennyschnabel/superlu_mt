...
int_t psgst02(trans_t trans, int_t m, int_t n, int_t nrhs, SuperMatrix *A,
	    float *x, int_t ldx, float *b, int_t ldb, float *resid)
{
/*
 ...
 *  =======
 *
 *  psgst02() computes the residual for a solution of a system of linear
...
*/
	...
	*resid = 1. / eps;
    ...
    sp_sgemm(transc, n1, nrhs, n2, alpha, A, x, ldx, beta, b, ldb);
